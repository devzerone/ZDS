  ...
  return (
    <div className="docs-page">
      <section className="docs-hero docs-hero--component">
        ...
        <p>
          현재는 Button과 Breadcrumb가 canonical docs, shared React implementation, Storybook preview를
          연결하는 reference component입니다. 다음 컴포넌트도 같은 구조를 따라 확장할 수 있게 설계했습니다.
        </p>
      </section>
      ...
      <section className="docs-split">
        <div className="docs-stack">
          <article className="docs-panel" id="reference-component">
            <span className="docs-eyebrow">Reference components</span>
            <h2>Button과 Breadcrumb는 docs, spec, token, pen, React를 연결하는 기준선입니다.</h2>
            <p>
              action component와 navigation component를 함께 기준선으로 두고, 문서에서 먼저 읽은 뒤 필요할
              때만 Storybook playground로 이동하는 흐름을 기준으로 삼습니다.
            </p>
            <div className="docs-actions">
              <Link className="preview-link" href="/components/button">
                Button 문서 보기
              </Link>
              <Link className="preview-link" href="/components/breadcrumb">
                Breadcrumb 문서 보기
              </Link>
